    ...
    <div class="flex-1 p-6">
        ...
        <div class="mt-8">
            ...
            <div class="p-6 bg-white rounded shadow">
                <h3 class="text-lg font-bold mb-4">Add
                    Menu
                </h3>
                ...
                <!-- Menu Form -->
                <form action="{{ route('menu.store') }}" method="POST" class="bg-white p-6 shadow-lg rounded-lg">
                    @csrf
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2" for="menu">
                            Menu link
                        </label>
            ...
            <div class="p-6 bg-white rounded shadow mt-8">
                <h3 class="text-lg font-bold mb-4">Menu Items</h3>
                <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                    <thead>
                        <tr class="border-b bg-gray-100">
                            <th class="text-left px-6 py-2 font-semibold text-gray-700">#</th>
                            <th class="text-left px-6 py-2 font-semibold text-gray-700">Menu link</th>
                            <th class="text-left px-6 py-2 font-semibold text-gray-700">Menu items</th>
                    ...
                    <tbody>
                        @foreach ($menus as $index => $menu)
                            <tr class="border-b">
                                ...
                                <td class="px-6 py-4 text-gray-700">{{ $menu->name }}</td>
                                <td class="px-6 py-4 text-gray-700">
                                    <a href="{{ route('menu.delete', $menu->id) }}"
                                        onclick="return confirm('Are you sure you want to delete {{$menu->name}} items?')"
